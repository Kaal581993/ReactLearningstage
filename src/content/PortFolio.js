...
const PortFolio = (props) => {
    ...
    return (
        <DefaultLayout>
            ...
            <Heading
                title="Some of My Designs, Projects and Development"
                subtitle="Given below is a list View, If you have any suggestions for a feature, Just Submit your Details on Contact US page let me know."
            />


            <Row type="flex" className="component--features">
                { MY_DESIGNS.map( (feature,index) => {
                    return (
